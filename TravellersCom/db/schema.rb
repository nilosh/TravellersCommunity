...
ActiveRecord::Schema.define(version: 2021_01_04_060217) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.bigint "trip_detail_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["trip_detail_id"], name: "index_reviews_on_trip_detail_id"
  ...
  add_foreign_key "reviews", "trip_details"
  add_foreign_key "reviews", "users"
  add_foreign_key "trip_details", "users"
